...
![Markdown 图标](https://markdown-here.com/img/icon256.png "Markdown 图标")

带链接的图片（点击图片跳转）：

[![示例](https://via.placeholder.com/200x100?text=Click+Me)](https://example.com)

HTML 方式可控制图片大小与对齐：

<div align="center">
  <img src="https://via.placeholder.com/300x80?text=Center+Image" alt="居中图片">
</div>
...
普通段落、**粗体文本**、*斜体文本*、~~删除文本~~、`inline code` 与 [可编辑链接](https://example.com/edit)。
