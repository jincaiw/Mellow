...
- **P6**：Export corpus 落地（修复 italics 字体缺失与表格转义管道两个真 bug）；Reader/Palette/Slash 默认隐藏与可发现性、AI 默认关闭（PRD §122）、User CSS 契约护栏落地；Pandoc / Previous Export / Image Export 为 PRD P1 roadmap 观察项。
