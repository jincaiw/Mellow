...
const zhCN = {
  ...
  'settings.export.placeholder': 'PDF / HTML 导出（P1）',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'settings.export.placeholder': 'PDF / HTML export (P1)',
  'settings.export.placeholderDesc': 'Export will arrive in a future release',
