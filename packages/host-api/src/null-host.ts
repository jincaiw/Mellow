...
export function createNullHost(): DesktopHost {
  return {
    fs: {
      ...
      download: notImplemented('fs.download'),
    },
    dialog: {
      ...
      showDirectory: notImplemented('dialog.showDirectory'),
    },
    clipboard: {
    ...
    window: {
      ...
      toggleMaximize: notImplemented('window.toggleMaximize'),
