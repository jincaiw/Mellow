...
export const BUILTIN_THEMES: MellowTheme[] = [
  ...
  // R2-3 Typora 主题语义位补齐（master-plan G4）：Whitey 极简高对比白 / Gothic 衬线深色
  {
    id: 'whitey',
    name: 'Whitey',
    kind: 'light',
    variables: {
      ...LIGHT_BASE,
      // Typora Whitey 方向：纯白底 + 近黑文字，最大对比、去装饰（参数原创）
      '--mellow-bg': '#ffffff',
      '--mellow-bg-elevated': '#ffffff',
      '--mellow-bg-subtle': '#fafafa',
      '--mellow-bg-hover': '#f0f0f0',
      '--mellow-fg': '#1a1a1a',
      '--mellow-fg-subtle': '#666666',
      '--mellow-fg-muted': '#999999',
      '--mellow-border': '#e8e8e8',
      '--mellow-border-strong': '#cccccc',
      '--mellow-accent': '#1a1a1a',
      '--mellow-tab-underline': '#1a1a1a',
      '--mellow-selection': '#ececec',
      '--mellow-code-bg': '#fafafa',
      '--mellow-code-border': '#e8e8e8',
    },
    themeCss: '',
    editorTheme: 'minimal-light',
  },
  {
    ...
    variables: {
      ...DARK_BASE,
      // Typora Gothic 方向：衬线学术风 + 暗紫红点缀（参数原创）
      '--mellow-bg': '#17141f',
      '--mellow-bg-elevated': '#1e1a29',
      '--mellow-bg-subtle': '#120f18',
      '--mellow-bg-hover': '#262133',
      '--mellow-fg': '#d8d4e0',
      '--mellow-fg-subtle': '#a09aad',
      '--mellow-fg-muted': '#7d7789',
      '--mellow-border': '#322c40',
      '--mellow-border-strong': '#4a4258',
      '--mellow-accent': '#b39ddb',
      '--mellow-tab-underline': '#b39ddb',
      '--mellow-selection': '#35304a',
      '--mellow-code-bg': '#1e1a29',
      '--mellow-code-border': '#322c40',
      '--mellow-content-font': "Georgia, 'Songti SC', 'Noto Serif SC', 'Times New Roman', serif",
    },
    themeCss: '',
