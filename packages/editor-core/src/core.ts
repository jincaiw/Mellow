...
export class EditorCore {
  ...
  setEditorConfig(method: 'setFontSize' | 'setFontFace' | 'setLineHeight' | 'setShowLineNumbers' | 'setLineWrapping' | 'setContentMaxWidth' | 'setAutoPair' | 'setMarkdownSyntaxPairs' | 'setDefaultCodeLang' | 'setCodeIndentSize' | 'setTabKeyBehavior' | 'setFirstLineIndent', params: { fontSize?: number; family?: string; lineHeight?: number; enabled?: boolean; width?: number | null; behavior?: number; lang?: string; indentWidth?: number }): void {
