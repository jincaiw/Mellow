...
export class EditorCore {
  ...
  setEditorConfig(method: 'setFontSize' | 'setFontFace' | 'setLineHeight' | 'setShowLineNumbers' | 'setLineWrapping' | 'setContentMaxWidth' | 'setAutoPair', params: { fontSize?: number; family?: string; lineHeight?: number; enabled?: boolean; width?: number | null }): void {
