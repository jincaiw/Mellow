...
export class EditorCore {
  ...
  setEditorConfig(method: 'setFontSize' | 'setFontFace' | 'setLineHeight' | 'setShowLineNumbers' | 'setLineWrapping', params: { fontSize?: number; family?: string; lineHeight?: number; enabled?: boolean }): void {
