...
function highlight() {
  ...
  return buildHighlight(colors, [
    ...
    { tag: [tags.className, tags.definition(tags.propertyName), tags.definition(tags.typeName), tags.codeInfo], color: '#953800' },
    // V7-I3：列表标记 Typora 对齐——与正文同色（此前 #953800 橙色）
    ...
    { tag: [tags.quote, tags.quoteMark], color: '#777777' },
  ]);
}
